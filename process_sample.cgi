...
def save_file(form, field_name, uploads_dir):
    """Save uploaded file if it exists, return filename or None."""
    if field_name in form:
        fileitem = form[field_name]

        if fileitem.filename:  # user actually selected a file
...
working_dir = "/Library/WebServer/Documents/plasmofasta_workingdir/"
uploads_dir = working_dir + "uploads_dir/"

kmer_list_path = "/Library/WebServer/Documents/25mer_rc_list.txt"
kmc_input_path = working_dir + "kmc_input.txt"

os.system("mkdir -p " + working_dir + " " + uploads_dir)

print("started")
email = "katie.ko@verizon.net"
file1 = "/Library/WebServer/Documents/plasmofasta_workingdir/uploads_dir/head_ERR15707893_1.fastq"
file2 = ""
sample_name = ""

print("Dir exists:", os.path.exists(working_dir))
print("Writable:", os.access(working_dir, os.W_OK))

#email = form.getvalue("email")
#form = cgi.FieldStorage()
#file1 = save_file(form, "file1", uploads_dir)
#file2 = save_file(form, "file2", uploads_dir)
#sample_name = ""


kmc_input_file = open(kmc_input_path, "w")

# Output results
if file1:
    print(f"<p>File 1 uploaded: {file1}</p>")
    kmc_input_file.write(file1 + "\n")
    sample_name = file1.split("/")[-1].split('.')[0]
else:
    print("<p>File 1 missing (required)</p>")

if file2:
    print(f"<p>File 2 uploaded: {file2}</p>")
    kmc_input_file.write(file2 + "\n")
else:
    print("<p>No second file uploaded (optional)</p>")

kmc_input_file.close()

#set up paths for running kmc
kmc_tmp_dir_path = working_dir + "kmc_tmp_dir/"
sample_dir_path = working_dir + sample_name + "/"
base_kmc_path = working_dir + sample_name + "_kmers"
kmers_dump_path = working_dir + sample_name + "_kmers_dump.txt"

os.system("mkdir -p " + sample_dir_path)
#run kmc
print("kmc command: " + "/Users/katie.ko/Documents/KMC3.2.4.mac.x64/bin/kmc @" + kmc_input_path + " " + base_kmc_path + " " + kmc_tmp_dir_path + " -k 25 -ci 0 -cs 1000000000000000 -t 16")
os.system("/Users/katie.ko/Documents/KMC3.2.4.mac.x64/bin/kmc @" + kmc_input_path + " " + base_kmc_path + " " + kmc_tmp_dir_path + " -k 25 -ci 0 -cs 1000000000000000 -t 16")
#run kmc dump
print("kmc dump command: " + "/Users/katie.ko/Documents/KMC3.2.4.mac.x64/bin/kmc_tools transform " + base_kmc_path + " dump " + kmers_dump_path)
os.system("/Users/katie.ko/Documents/KMC3.2.4.mac.x64/bin/kmc_tools transform " + base_kmc_path + " dump " + kmers_dump_path)
...
kmc_output_file = open(kmers_dump_path, 'r')
...
#clean up files
#os.system("rm " + base_kmc_path + ".kmc_*")
#os.system("rm " + kmers_dump_path)
#os.system("rm " + sample_dir_path)
